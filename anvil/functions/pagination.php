...
if ( ! function_exists( 'forge_page_navi' ) ) :
	...
	function forge_page_navi($before = '', $after = '', $query = '') {
		...
		echo '<li class="">';
		previous_posts_link('&larr; Previous', $query);
		echo '</li>';
		...
		echo '<li class="">';
		next_posts_link('Next &rarr;', $query->max_num_pages);
		echo '</li>';
		if ($end_page < $max_page) {
			$last_page_text = "&raquo;";
			echo '<li class="next"><a href="'.get_pagenum_link($max_page).'" title="Last">'.$last_page_text.' '.$max_page.'</a></li>';
		}
		echo '</ul>'.$after."";
	}
